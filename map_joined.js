...
function initialize() {
    ...
    var map_data = map_canvas.dataset;

    var infowindow = new google.maps.InfoWindow(),
        markers = {},
        category,
        mapOptions = {
            backgroundColor: map_data['background-color'],
            center: new google.maps.LatLng(parseFloat(map_data['centre-lat']), parseFloat(map_data['centre-lng'])),
            mapTypeId: map_data['type-id'],
            mapTypeControlOptions: {style: google.maps.MapTypeControlStyle.DROPDOWN_MENU},
            maxZoom: parseInt(map_data['max-zoom']),
            minZoom: parseInt(map_data['min-zoom']),
            panControl: false,
            rotateControl: false,
